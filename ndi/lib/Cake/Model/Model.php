 ...
 */
	protected function _readDataSource($type, $query) {
		...
		if ($this->findMethods[$type] === true && ($query['callbacks'] === true || $query['callbacks'] === 'after')) {
 ...
 */
	public function buildQuery($type = 'first', $query = array()) {
		...
		if (($query['callbacks'] === true || $query['callbacks'] === 'before') && $this->findMethods[$type] === true) {
